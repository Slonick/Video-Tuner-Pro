// Video Tuner Pro — content script entry (Chrome + Firefox).
// Loads settings, drives the steady background tick + DOM observer, and reacts to
// settings changes. Imported modules register their own listeners/samplers.
import { api, STORE, STORE_AREA, ctxValid, clamp, clampTarget, clampMax, clampNum, getDomain } from "./env.js";
import { S } from "./state.js";
import { applyAll } from "./speed.js";
import { controlLive, resetSyncAnnounce } from "./live.js";
import { applyAudioComp, announceAudioStatus } from "./audio.js";
import { updateTimeBadge, flashBadge, ownsNode } from "./badge.js";
