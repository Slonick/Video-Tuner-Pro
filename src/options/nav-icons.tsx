// Monochrome sidebar glyphs for the options nav — they inherit currentColor so the
// active row tints them white. One per grouped section (General / Speed / Audio /
// Data). Kept here, separate from the popup's filled icon set, since these are
// stroke icons sized for the 18px nav slot.
